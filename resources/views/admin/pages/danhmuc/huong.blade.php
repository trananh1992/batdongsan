              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i=1; ?>
                    ...
                    <tr>
                      <td>{{$i++}}</td>
                      <td id="tenhuong{{$h->_id}}">{!! $h->tenhuong !!}</td>
                     
                      <td><button class="btn btn-primary a-btn-slide-text" data-toggle="modal" data-target="#suahuong" value="{{$h->_id}}" onclick="suahuong(this)">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                          <span><strong>Chỉnh sửa</strong></span>            
                      </button>
                      </td>
                        <td><button id="xoahuong{{$h->id}}"  value="{{$h->id}}" onclick="xoahuong(this)" class="btn btn-danger a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formsuahuong" action="{{ URL::to('admin/danhmuc/suahuong')}}" method="POST" enctype="multipart/form-data">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formthemhuong" action="{{ URL::to('admin/danhmuc/themhuong')}}" method="POST" enctype="multipart/form-data">
