      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <!-- content goes here -->
            <form id="form_insert" action="{{ URL::to('addloaibds')}}" method="POST" enctype="multipart/form-data">
              <div id="ketqua" >
              </div>
              ...
              <tr>
                ...
                <td>Loại Đất</td>
                <td><input class="form-control" name="tenhuong"  placeholder="Tên loại đất"/></td>
              </tr>
              <tr>
