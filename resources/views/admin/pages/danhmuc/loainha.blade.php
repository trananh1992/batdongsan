              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i=1; ?>
                    ...
                    <tr>
                      <td>{{$i++}}</td>
                      <td id="ten{{$item->_id}}">{!! $item->tenloainha !!}</td>
                      ...
                      <td><button class="btn btn-primary a-btn-slide-text" data-toggle="modal" data-target="#sua" value="{{$item->_id}}" onclick="sua(this)">
                        ...
                        <td><button id="xoaloainha{{$item->id}}"  value="{{$item->id}}" onclick="xoa(this)" class="btn btn-danger a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formsua" action="{{ URL::to('admin/danhmuc/sualoainha')}}" method="POST" enctype="multipart/form-data">
          <div id="ketquasua" >
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formthem" action="{{ URL::to('admin/danhmuc/themloainha')}}" method="POST" enctype="multipart/form-data">
          <div id="ketquathem" >
          </div>
          <table class="table table-striped table-hovered">
            <tr>
