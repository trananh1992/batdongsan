              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i=1; ?>
                    ...
                    <tr>
                      <td>{{$i++}}</td>
                      <td id="ten{{$item->_id}}">{!! $item->tenloaivp !!}</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formsua" action="{{ URL::to('admin/danhmuc/sualoaivp')}}" method="POST" enctype="multipart/form-data">
          <div id="ketquasua" >
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formthem" action="{{ URL::to('admin/danhmuc/themloaivp')}}" method="POST" enctype="multipart/form-data">
          <div id="ketquathem" >
          </div>
          <table class="table table-striped table-hovered">
            <tr>
