<?php /* D:\xampp\htdocs\batdongsan\resources\views/admin/pages/danhmuc/loainha.blade.php */ ?>
 ...
 -->
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Danh Mục Loại Nhà</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i=1; ?>
                    ...
                    <tr>
                      <td><?php echo e($i++); ?></td>
                      <td id="ten<?php echo e($item->_id); ?>"><?php echo $item->tenloainha; ?></td>
                      ...
                      <td><button class="btn btn-primary a-btn-slide-text" data-toggle="modal" data-target="#sua" value="<?php echo e($item->_id); ?>" onclick="sua(this)">
                        ...
                        <td><button id="xoaloainha<?php echo e($item->id); ?>"  value="<?php echo e($item->id); ?>" onclick="xoa(this)" class="btn btn-danger a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="lineModalLabel">Chỉnh sửa loại Nhà</h3>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">

        <!-- content goes here -->
        <form id="formsua" action="<?php echo e(URL::to('admin/danhmuc/sualoainha')); ?>" method="POST" enctype="multipart/form-data">
          <div id="ketquasua" >
          </div>
          ...
          <table class="table table-striped table-hovered">
            <tr>
              ...
              <td>Tên loại nhà</td>
              <td><input class="form-control" id="tendanhmuc" name="tendanhmuc"  placeholder="Tên loại nhà" autofocus/></td>
            </tr>
          </table>
...
<div class="modal fade" id="them" role="dialog" aria-labelledby="modalLabel" aria-hidden="false" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="lineModalLabel">Thêm Loại Nhà</h3>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">

        <!-- content goes here -->
        <form id="formthem" action="<?php echo e(URL::to('admin/danhmuc/themloainha')); ?>" method="POST" enctype="multipart/form-data">
          <div id="ketquathem" >
          </div>
          <table class="table table-striped table-hovered">
            <tr>
              ...
              <td>Tên loại nhà</td>
              <td><input class="form-control" id="txt_ten" name="ten"  placeholder="Tên loại nhà" autofocus/></td>
            </tr>
          </table>
          <div style="float: right;">
            <button type="submit"  class="btn btn-info btnluu">Lưu lại</button></td>
...
function xoa(e){
    ...
    if(confirm("Bạn chắc chắn muốn xóa loại nhà: "+tendanhmuc + " không ?") == true){
      var url = base_url+'/admin/danhmuc/xoaloainha/'+e.value;
      $.ajax({
        type : 'get',
        url : url,
        // data : data,
