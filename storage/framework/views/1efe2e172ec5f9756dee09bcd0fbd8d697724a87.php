<?php /* D:\xampp\htdocs\batdongsan\resources\views/admin/pages/danhmuc/loaicanho.blade.php */ ?>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i=1; ?>
                    ...
                    <tr>
                      <td><?php echo e($i++); ?></td>
                      <td id="ten<?php echo e($item->_id); ?>"><?php echo $item->tenloaicanho; ?></td>
                      ...
                      <td><button class="btn btn-primary a-btn-slide-text" data-toggle="modal" data-target="#sua" value="<?php echo e($item->_id); ?>" onclick="sua(this)">
                        ...
                        <td><button id="xoaloaicanho<?php echo e($item->id); ?>"  value="<?php echo e($item->id); ?>" onclick="xoa(this)" class="btn btn-danger a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formsua" action="<?php echo e(URL::to('admin/danhmuc/sualoaicanho')); ?>" method="POST" enctype="multipart/form-data">
          <div id="ketquasua" >
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- content goes here -->
        <form id="formthem" action="<?php echo e(URL::to('admin/danhmuc/themloaicanho')); ?>" method="POST" enctype="multipart/form-data">
          <div id="ketquathem" >
          </div>
          <table class="table table-striped table-hovered">
            <tr>
