<?php /* D:\xampp\htdocs\batdongsan\resources\views/admin/pages/tintuc/index.blade.php */ ?>
<?php $__env->startSection('contentadmin'); ?>
 ...
 -->
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $i=1; ?>
                    ...
                    <tr>
                      <td><?php echo e($i++); ?></td>
                      <td><?php echo $t->tieu_de; ?></td>
                      <td><?php echo $t->noi_dung; ?></td>
        ...
        <a href="tintucadd" /><button type="button" class="btn btn-success">Thêm mới</button></a>
